...
#patch -Np1 -r - sources/meta-seco-bsp-release-imx8-3-0-0/recipes-bsp/imx-mkimage/imx-boot_0.2.bb < sources/meta-seco-bsp-release-imx8-3-0-0/patches/dtb-not-fetch-fix-the-bug.patch
# Patch meta-fsl layer adding dtbo support
patch -Np1 -r - sources/meta-fsl-bsp-release/imx/meta-bsp/classes/image_types_fsl.bbclass < sources/meta-seco-bsp-release-imx8-3-0-0/patches/DTBo-not-fetch.patch
...
echo "BBLAYERS += \" \${BSPDIR}/sources/meta-seco-bsp-release-imx8-3-0-0 \"" >> $BUILD_DIR/conf/bblayers.conf
